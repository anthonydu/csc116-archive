...
public class HandTest {
    ...
    public void testIsStraightFlush() {
        Card[] cards = {new Card(5,'s'), new Card(6,'s'), new Card(7,'s'), new Card(8,'s'),
                        new Card(9,'s')};
    ...
    public void testIsRoyalFlush() {
        Card[] cards = {new Card(10,'d'), new Card(11,'d'), new Card(12,'d'), new Card(13,'d'),
                        new Card(14,'d')};
    ...
    public void testHasFourOfAKind() {
        Card[] cards = {new Card(10,'d'), new Card(10,'s'), new Card(10,'c'), new Card(10,'h'),
                        new Card(8,'h')};
    ...
    public void testHasThreeOfAKind() {
        Card[] cards = {new Card(10,'d'), new Card(7,'s'), new Card(10,'c'), new Card(10,'h'),
                        new Card(8,'h')};
    ...
    public void testHasTwoPairs() {
        Card[] cards = {new Card(10,'c'), new Card(7,'s'), new Card(7,'c'), new Card(10,'h'),
                        new Card(8,'h')};
    ...
    public void testHasOnePair() {
        Card[] cards = {new Card(3,'c'), new Card(7,'s'), new Card(7,'c'), new Card(10,'h'),
                        new Card(8,'h')};
